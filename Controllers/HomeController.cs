...
public class HomeController : Controller
{
    ...
    public IActionResult Index()
    {
        ...
        // Instância do ipo cliente
        Cliente cliente1 = new Cliente(01, "Arthur A. Ferreira", "123.456.789-00", "arthur.antunes@sp.senai.br", "Madruga");
        Cliente cliente2 = new Cliente(02, "William Henry Gates III", "039.456.763-55", "bill@microsoft.com", "Bug");
        ...
        Fornecedor fornecedor4 = new Fornecedor(04, "Tik Tol Dogs", "87.945.350/0001-83", "noisnamidia@tiktokdogs.uk");
